...
const dateSchema: Plugin<DateSchema> = { pdf: pdfRender, ui: uiRender, propPanel };

export default dateSchema;

export const readOnlyText: Plugin<DateSchema> = {
  pdf: dateSchema.pdf,
  ui: dateSchema.ui,
  propPanel: {
    ...dateSchema.propPanel,
    defaultSchema: {
      ...dateSchema.propPanel.defaultSchema,
      type: 'readOnlyText',
